...
const Artworks = (0, import_index_8f0b34dd.c)(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"heading"}"><h2>Artworks</h2></div>

<div class="${"card  svelte-lwnjp5"}"><div class="${"container svelte-lwnjp5"}"><img src="${"artworks.webp"}" alt="${"Artworks"}" class="${"svelte-lwnjp5"}">
		<div class="${"overlay svelte-lwnjp5"}"><div class="${"text svelte-lwnjp5"}"><a class="${"link svelte-lwnjp5"}" href="${"https://skuret.eu/kea/1semester/artworks/"}" target="${"blank"}">SE SIDEN \u279D</a></div></div></div></div>
...
<div class="${"container svelte-lwnjp5"}"><section class="${"svelte-lwnjp5"}"><h3>Opgaven</h3>
	...
	<section class="${"svelte-lwnjp5"}"><div class="${"my-8 flex justify-between"}"><a sveltekit:prefetch href="${"/Portfolio"}">\u{1F814} G\xC5 TILBAGE</a>
			<a class="${"se-siden svelte-lwnjp5"}" href="${"https://skuret.eu/kea/1semester/artworks/"}" target="${"blank"}">SE SIDEN \u279D</a></div></section>
</div>`;
});
